...
namespace ECS_AnimationSystem {
    ...
    public static class ECS_Animation {
        ...
        public static void PlayAnimJobs(Entity entity, int index, EntityCommandBuffer.ParallelWriter entityCommandBuffer, Skeleton_Data skeletonData, ECS_UnitAnimType.TypeEnum ecsUnitAnimTypeEnum, UnitAnim.AnimDir animDir, Skeleton_Anim_OnComplete onComplete) {
        ...
        public static void PlayAnimForcedJobs(Entity entity, int index, EntityCommandBuffer.ParallelWriter entityCommandBuffer, ECS_UnitAnimType.TypeEnum ecsUnitAnimTypeEnum, UnitAnim.AnimDir animDir, Skeleton_Anim_OnComplete onComplete) {
            Skeleton_Data skeletonData = GetSkeletonData(ecsUnitAnimTypeEnum, animDir, onComplete);
